(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('mfgtoolingApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-mfgtoolingApp-error');
                var entityKey = httpResponse.headers('X-mfgtoolingApp-params');
                if (errorHeader) {
